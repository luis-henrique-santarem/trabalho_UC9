...
public class taskForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        statusField.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
    ...
    if (selectedLine != -1) {
        ...
        if (title.isEmpty() || description.isEmpty() || date.isEmpty() || status.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Preencha todos os campos para editar a tarefa.");
            return;
        }

        modelTable.setValueAt(title, selectedLine, 1);
        modelTable.setValueAt(description, selectedLine, 2);
        modelTable.setValueAt(date, selectedLine, 3);
        modelTable.setValueAt(status, selectedLine, 4);
    ...
    int selectedLine = listTask.getSelectedRow();
     if(selectedLine != -1) { 
         modelTable.removeRow(selectedLine);
     }else { 
    ...
    if (title.isEmpty() || description.isEmpty() || date.isEmpty() || status.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Preencha todos os campos para adicionar uma tarefa.");
        return;
    }

    Object[] newRow = {modelTable.getRowCount() + 1, title, description, date, status};
