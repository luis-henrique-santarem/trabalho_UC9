...
String title = titleField.getText();
        ...
        modelTable.setRowCount(0); // define o numero de linhas
        
        Task user = TaskDAO.searchTaskByTitle(title);
        modelTable.addRow(new Object[] {user.getId(),user.getTitle() });
